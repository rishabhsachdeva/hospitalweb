...
<ul id="navigation" class="nav-main">
    <li><a href="http://localhost:8080/jhos-war/his.jsp" class="barincrease">Home</a></li>
        
    <li class="list"><a href="#">About</a>
	<ul class="nav-sub">
    <li><a href="http://localhost:8080/jhos-war/overview.jsp">About Max</a></li>
		<li><a href="http://localhost:8080/jhos-war/vision.jsp">Vision</a></li>
	</ul>
	</li>
        
    <li class="list"><a href="#">Appointments</a>
	<ul class="nav-sub">
    <li><a href="http://localhost:8080/jhos-war/book.jsp">Book Appointment</a></li>
		<li><a href="http://localhost:8080/jhos-war/check.jsp">Check Appointment</a></li>
		<li><a href="http://localhost:8080/jhos-war/book.jsp">Cancel Appointment</a></li>
	</ul>
	</li>
    
    
    <li><a href="http://localhost:8080/jhos-war/map.html" class="barincrease">Locate Us</a></li>
    <li><a href="https://maxindia.com/contact-us/" class="barincrease">Contact Us</a></li>
    <li><a href="http://localhost:8080/jhos-war/logout.jsp" class="barincrease">Log-Out</a></li>
